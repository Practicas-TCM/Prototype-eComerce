        ...
        <div>
            <ul>
                ...
                <li type="square"><span style={{ fontWeight: "bolder" }}>ENUNCIAT: </span> <br></br>
                    <p>El projecte prototype té com a objectiu potenciar l’autoaprenentatge i la possibilitat d’aprendre noves tecnologies que possiblement no es poden ensenyar a la carrera, per falta de temps o per ser molt específiques.
                    </p>
                ...
                <li type="square"><span style={{ fontWeight: "bolder" }}>PROPOSTA: </span> <span>eCommerce</span> <br></br>
                    ...
                    <ul>
                        ...
                        <li type="circle">Cada producte té una pàgina amb la seva descripció i característiques</li>
                        ...
                        <li type="circle">Una pàgina per registrar-se</li>
                        <li type="circle">Una pàgina per accedir al teu perfil d'usuari</li>
                        <li type="circle">Una pàgina perquè l'usuari pugui fer-se prèmium.</li>
                        ...
                        <li type="circle">Una pàgina on s'explica qui som i que és aquest projecte.</li>
                    </ul>                   
                </li>
            </ul>
        </div>
